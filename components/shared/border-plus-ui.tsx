        ...
        <>
            <div
                className={cn(
                    ...
                    "group-hover:-right-1 group-hover:-top-1"
                )}
            >
                +
            </div>
            ...
            <div
                className={cn(
                    ...
                    "group-hover:-right-1 group-hover:-bottom-1"
                )}
            >
                +
            </div>
            ...
            <div
                className={cn(
                    ...
                    "group-hover:-left-1 group-hover:-top-1"
                )}
            >
                +
            </div>
            ...
            <div
                className={cn(
                    ...
                    "group-hover:-left-1 group-hover:-bottom-1"
                )}
            >
                +
            </div>
